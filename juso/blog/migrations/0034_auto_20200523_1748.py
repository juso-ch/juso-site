...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='wpimport',
            options={'verbose_name': 'wordpress import', 'verbose_name_plural': 'wordpress imports'},
        ),
        ...
        migrations.AlterField(
            ...
            name='form',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blog_formplugin', to='forms.Form', verbose_name='form'),
        ),
        migrations.AlterField(
            model_name='glossaryrichtext',
            name='entries',
            field=models.ManyToManyField(related_name='blog_glossaryrichtext_related', related_query_name='blog_glossaryrichtexts', to='glossary.Entry', verbose_name='entries'),
        ),
        migrations.AlterField(
            model_name='image',
            name='caption',
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='blog.NameSpace', verbose_name='default namespace'),
        ),
        migrations.AlterField(
            model_name='wpimport',
            name='section',
