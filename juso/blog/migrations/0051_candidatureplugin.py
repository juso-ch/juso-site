...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('blog', '0050_remove_eventplugin_namespace'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blog_candidatureplugin_set', to='blog.article')),
            ],
            options={
