...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='location',
            name='translations',
            field=models.ManyToManyField(related_name='_location_translations_+', to='events.Location'),
        ),
        migrations.AddField(
            model_name='namespace',
            name='translations',
            field=models.ManyToManyField(related_name='_namespace_translations_+', to='events.NameSpace'),
        ),
    ]
