...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='namespace',
            options={'ordering': ['name'], 'verbose_name': 'namespace', 'verbose_name_plural': 'namespaces'},
        ),
        migrations.AddField(
            model_name='event',
            name='uuid',
        ...
        migrations.AlterField(
            ...
            name='articles',
            field=models.ManyToManyField(blank=True, related_name='events_articleplugin', to='blog.Article', verbose_name='articles'),
        ),
        migrations.AlterField(
            model_name='articleplugin',
            name='category',
        ...
        migrations.AlterField(
            ...
            name='form',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='events_formplugin', to='forms.Form', verbose_name='form'),
        ),
        migrations.AlterField(
            model_name='image',
            name='caption',
