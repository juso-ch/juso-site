...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='help_text',
            field=models.CharField(blank=True, max_length=240, verbose_name='help text'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='forms_richtext_set', to='forms.Form')),
            ],
            options={
