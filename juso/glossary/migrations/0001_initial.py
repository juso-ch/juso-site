    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auto_pattern', models.BooleanField(default=True, verbose_name='auto-pattern')),
                ('pattern', models.CharField(max_length=200, verbose_name='pattern')),
                ('content', models.TextField()),
                ('translations', models.ManyToManyField(blank=True, related_name='_entry_translations_+', to='glossary.Entry')),
            ],
            options={
                'ordering': ['name'],
            },
