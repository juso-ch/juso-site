    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu', models.CharField(blank=True, choices=[('main', 'main navigation'), ('footer', 'footer navigation')], default='main', max_length=20, verbose_name='menu')),
                ...
                ('application', models.CharField(blank=True, choices=[('blog', 'blog')], max_length=20, verbose_name='application')),
                ('app_instance_namespace', models.CharField(blank=True, editable=False, max_length=100, verbose_name='app instance namespace')),
                ('is_landing_page', models.BooleanField(default=False, verbose_name='is landing page')),
            ],
            options={
                'verbose_name': 'page',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.CharField(max_length=255)),
                ('ordering', models.IntegerField(default=0)),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pages_team_set', to='pages.Page')),
            ],
            options={
                'verbose_name': 'team',
