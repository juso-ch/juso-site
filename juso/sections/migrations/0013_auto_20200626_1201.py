...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('sections', '0012_auto_20200624_2250'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='category',
            name='meta_card_type',
            field=models.CharField(blank=True, choices=[('summary', 'summary'), ('summary large image', 'summary_large_image'), ('player', 'player')], help_text='Card type', max_length=50, verbose_name='twitter card type'),
        ),
        migrations.AddField(
            model_name='category',
            name='meta_player',
